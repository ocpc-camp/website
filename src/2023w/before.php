    ...
    <div class="container body-content">
        <nav class="navbar navbar-expand-lg">
          <div class="container-fluid">
            <a class="navbar-brand" href="."><img class="site-logo" src="/images/ocpc.svg" alt="ocpc logo"></a>
        ...
        <b>You are viewing an archived website for a previous iteration of the camp. Click <a href="/">here</a> to access the website for the current camp.</b>
